...
public class TipoTelefonoModelo {
    ...
    public RespuestaTipoTelefono MostrarTelefonos() {
        ...
        try {
            ...
            PreparedStatement consulta = con.prepareStatement("SELECT ID, DESCRIPCION, CLAVE, ID_TELEFONIA FROM C_TIPO_TELEFONO WITH (NOLOCK)"); // hacer la conexion mandando llamar al query de arriba
    ...
    public static Respuesta agregarTelefono(TipoTelefono tipoTelefono) {
        ...
        try {
            con = pool.getConnection("activa");//aqui se conecta
            PreparedStatement ps = con.prepareStatement("INSERT INTO C_TIPO_TELEFONO (DESCRIPCION, CLAVE, ID_TELEFONIA) VALUES (?, ?, ?)");
    ...
    public static Respuesta editarTelefono(TipoTelefono tipoTelefono) {
        ...
        try {
            con = pool.getConnection("activa");//aqui se conecta
            PreparedStatement ps = con.prepareStatement("UPDATE C_TIPO_TELEFONO SET DESCRIPCION=?, CLAVE=?, ID_TELEFONIA=? WHERE ID=?");
